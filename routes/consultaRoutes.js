...
const { obtenerConsultasRealizadas } = require('../controllers/consultaController');
...
router.get('/consultas-realizadas', authMiddleware, obtenerConsultasRealizadas);
//router.get('/consultas/seguimiento/:idConsulta', authMiddleware, consultaController.obtenerSeguimientoConsulta);
//router.get('/medicamentos', consultaController.obtenerMedicamentosActivos);
//router.get('/examenes', consultaController.obtenerExamenes);
